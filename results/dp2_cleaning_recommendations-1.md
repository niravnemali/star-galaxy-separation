...
| `cmd_gi_zoom_display` | 624,684 | 0.8529 |
...
| `cmd_gi_zoom_display` | 768,237 | 0.8880 |
...
- CMD and color plots: use reasonable display limits by default: magnitudes 15-28 and ordinary colors -1 to 5. Clean/zoom CMD uses `cmd_gi_cmodel_clean`, not `all_bands_psf_cmodel_ready`.
